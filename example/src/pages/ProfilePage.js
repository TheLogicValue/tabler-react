        ...
        <Container>
          <Grid.Row>
            <Grid.Col lg={4}>
              <Profile
                name="John Doe"
                backgroundURL={baseimages + "photos/eberhard-grossgasteiger-311213-500.jpg"}
                ...
                <Card.Body>
                  <Media>
                    <Avatar
                      size="xxl"
                      className="mr-5"
                      imageURL={baseimages + "faces/male/21.jpg"}
                    />
                    <Media.BodySocial
                      name="Juan Hernandez"
              ...
              <Card>
                ...
                <Card.Body>
                  <Form>
                    <Grid.Row>
                      <Grid.Col auto>
                        <Avatar size="xl" imageURL={baseimages + "faces/female/9.jpg"} />
                      </Grid.Col>
                      <Grid.Col>
                        <Form.Group>
                ...
                <Comment.List>
                  <Comment
                    ...
                    replies={
                      <React.Fragment>
                        <Comment.Reply
                          name="Debra Beck"
                          avatarURL={baseimages + "faces/female/17.jpg"}
                        ...
                        <Comment.Reply
                          name="Jack Ruiz"
                          avatarURL={baseimages + "faces/male/32.jpg"}
                  ...
                  <Comment
                    ...
                    replies={
                      <Comment.Reply
                        name="Wayne Holland"
                        avatarURL={baseimages + "faces/male/26.jpg"}
                        text=" Donec id elit non mi porta gravida at eget metus. Vivamus sagittis lacus vel augue laoreet rutrum faucibus dolor auctor. Donec ullamcorper nulla non metus auctor fringilla. Praesent commodo cursus magna, vel scelerisque nisl consectetur et. Sed posuere consectetur est at lobortis."
                      />
                    }
                  />
